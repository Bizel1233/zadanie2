...
export const SelectTableComponentElement = () => {
	const { data, onSetPage, countPage, isLoading, page, onclose, itemsPerPage, itemsPerPageOptions, setItemsPerPage } =
						...
						>
							...
							<Box display={"flex"} gap={"30px"} alignItems={"center"}>
								<FormControl sx={{ m: 1, minWidth: 60 }} size="small" variant="outlined">
									<Select value={itemsPerPage ?? ""} onChange={(e) => setItemsPerPage?.(e.target.value as number)}>
